...
| 序号 | 阶段                      | 描述                              | 进度   | 备注 |
|------|---------------------------|-----------------------------------|--------|------|
| 1    | 后台初始化和集成基础功能  | 初始化后台环境并集成基础功能      | 进行中 |      |
| 2    | 集成功能API接口并集成测试 | 集成功能API接口，并进行相应的测试 |        |      |
| 3    | 集成UI前端并集成测试      | 集成UI前端，并进行相应的测试      |        |      |
...
| 序号 | 模块     | 服务                     | 模块名称                             | AQ1 | AQ2 | AQ3 | AQ4 | AQ5 | AQ6 |
|------|----------|--------------------------|--------------------------------------|:---:|:---:|:---:|:---:|:---:|:---:|
...
| 序号 | 模块     | 服务                     | 模块名称                             | AQ7 | AQ8 | AQ9 | AQ10 |
|------|----------|--------------------------|--------------------------------------|-----|-----|-----|------|
| 2    |          | 02. 前端开发框架（桌面） | alinesno-infra-ui                    |     |     |     |      |
| 3    |          | 03. 前端开发框架（移动） | alinesno-infra-app                   |     |     |     |      |
|      |          |                          |                                      |     |     |     |      |
