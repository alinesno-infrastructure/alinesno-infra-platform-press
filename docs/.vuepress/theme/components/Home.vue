  ...
  <div class="home">
    ...
    <section class="row td-box td-box--primary position-relative td-box--gradient td-box--height-auto">
      <div class="container text-center td-arrow-down">
        <span class="h4 mb-0">
          <h3>基础设施服务 AIP产品优势</h3>
          <p>
            AIP基础设施（Alinesno Infrastructure Platform）是业务应用生命周期管理和监控的新一代基设， 为业务发展提供
    ...
    <section class="row td-box td-box--primary position-relative td-box--gradient td-box--height-auto"
      ...
      <div class="container text-center td-arrow-down">
        <span class="h4 mb-0">
          <h3 style="color:#555">AIP 可以帮助我做什么</h3>
    ...
    <div class="features-box" style="background-color:#fff;padding-bottom:6rem">
      ...
      <div style="position: relative;max-width: 1024px;margin: auto;">
        <img :src="$withBase('/aip_product_arc.jpg')" style="width: 100%;margin: auto;">
      </div>
      ...
      helpAll: [
        {
          title: '开箱即用的AIP基设系统',
          details:
            '基于基设体系，提供生产可使用的系统工具，包括技术体系，技术平台和研发基设管理工具，完善的团队切入流程',
          icon: 'fas fa-laptop-code'
        },
        {
          title: '快速实现基础设施和业务集成',
          details:
            '基于基设体系和工具，快速集成业务体系的管理体系，提供业务建设需要的平台化能力和稳定的开发框架，使业务快速整合',
          icon: 'fab fa-pinterest-square'
        },
        {
          title: '研发基设和团队组快速结合',
          details:
            '针对于中小型团队的特点，提供示例和基础入门工程，同时提供相关案例的项目架构文档参考，团队快速成长和切入企业基设',
      ...
      functionAll: [
        {
          title: '完善的基础设施体系',
          details:
            '包含平台化、基设化、保障体系，支持技术、研发、标准、数据、运营一体化的基设建设体系，业务应用生命周期管理和监控的新一代基设。',
          icon: 'fab fa-angular'
        },
        {
          title: '可视化多团队研发平台',
          details:
            '可视化友好的管理平台，提供多团队管理的平台，适配为多部门，多外包等体系，形成多方合作，共同基于同一基设建设业务数字化。',
          icon: 'fab fa-artstation'
        },
        {
          title: '通用的业务开发组件',
          details:
            '根据元数据，提取出通用的，基础的业务组件，形成标准规范，沉淀规范，基设提供基础的通用的业务研发组件，让专业更专注于场景和需求',
          icon: 'fas fa-bus-alt'
        },
        {
          title: '转量级数据治理体系',
        ...
        },
        {
          title: '云原生容器化架构体系',
          details:
            '基设天然的云原生架构，结合k8s/docker等容器化技术，快速实现云平台架构，跟进行业先进架构，提供完善的传统架构到云平台架构方案。',
          icon: 'fas fa-dove'
        },
        {
          title: '完善的项目实践文档',
          details:
            '标准基设体系在每个流程环节都有标准的文档交付流程，从技术、项目、产出、团队体系还有沉淀等，基于基设建设支撑的一套基设管理文档',
      ...
      featuresAll: [
        {
          title: '一套技术研发基础框架和方法',
          details:
            '为企业基础架构和统一研发云平台，为企业提供统一研发平台， 代码生成器开发平台。整体平台从规范、组织、架构-、业务、持续集成、自动化、在线升级全方位企业级基础设施研发解决方案',
          icon: 'fas fa-feather'
        },
        {
          title: '一套技术研发基设和数据基设底座',
          details:
            '针对于大中小型团队合适的开发平台，支持微服务化、基设化、统一权限和基础能力管理，数据采集、计算、治理运营输出，提供技术到业务再到数据一条线的基础数字化能力',
          icon: 'fas fa-tags'
        },
        {
