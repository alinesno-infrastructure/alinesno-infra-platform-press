...
它以技术创新和信息网络为基础，旨在支持软件行业的数字转型、智能升级和融合创新。软件新基础设施的建设涉及多个领域，包括云计算、基设架构、容器化、持续集成和部署、大数据处理、人工智能等。
...
## 作者简介
软件工程师罗小东，当前职业为技术架构师。有多个千万的政务和数字化项目架构和企业平台化、基设化转型经验。社区和产品负责人，AIP基于开源项目alinesno-infrastructure做进一步升级的产品。

相关信息:

- 博客: http://switch.linesno.com
- 公众号: 软件工程师罗小东
- 邮箱: luoandon@gmail.com
